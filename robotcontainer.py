...
class RobotContainer:
    ...
    def configureTriggers(self) -> None:
        ...
        commands2.Trigger(lambda: self.driver_controller_raw.get_trigger("R", 0.3)).whileTrue(
        ...
        commands2.Trigger(lambda: self.driver_controller_raw.get_trigger("L", 0.5)).whileTrue(
